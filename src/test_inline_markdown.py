...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_split_image_leading_image(self):
        node = TextNode(
    ...
    def test_split_image_all_images_no_spaces(self):
        node = TextNode(
            "![image](https://i.imgur.com/zjjcJKZ.png)![second image](https://i.imgur.com/3elNhQu.png)",
            TextType.TEXT,
        )
    ...
    def test_split_link_leading_link(self):
        node = TextNode(
    ...
    def test_split_link_all_links_no_spaces(self):
        node = TextNode(
